...
public class UpdateUserServlet extends HttpServlet {
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		if(result>0){
			out.println("<script>alert('修改成功!');window.location.href='/TrainStation/GetUsersServlet';</script>");
			out.close();
		}else{
			out.println("<script>alert('修改失败，请重试！');window.location.href='/TrainStation/GetUsersServlet'</script>");
			out.close();
		}
	}
