          ...
          <td height="62" background="/TrainStation/images/nav04.gif">
		   ...
		   <table width="98%" border="0" align="center" cellpadding="0" cellspacing="0">
		    <tr>
			  ...
			  <td width="519">
			  <form name="fom" id="fom" method="post" action="/TrainStation/BuyTicketServlet">
			...
			目的地：<input name="end" type="text" size="12" value="${condition.terminus}"/>
			   日期：<input name="leaveTime" type="text" id="EntTime" size="12" value="${condition.leaveTime}" onclick="showCalendar('EntTime', 'y-mm-dd')"  />
              ...
              <tr>
                <td height="40" class="font42"><table width="100%" border="0" cellpadding="4" cellspacing="1" bgcolor="#464646" class="newfont03">
                 ...
                 <tr>
                  ...
                  <tr>
                    <td  align="center" bgcolor="#FFFFFF"><a href="/TrainStation/GetTrainServlet?train_num=${ticket.train_num }" style="color:blue;">${ticket.train_num }</a></td>
                    ...
                    <td align="center" bgcolor="#FFFFFF">
                    	<form name="forms"  method="post" action="/TrainStation/ToBuyTicketServlet">
