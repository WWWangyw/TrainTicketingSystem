...
<form action="${APP_PATH }/comment" method="post">
	<table class="zhu">
		<tr>
			<td>
				留言板：
			...
			<td>
				<textarea name="content" rows="3" cols="100" id="myArea" onKeyUp="keypress2()" onblur="keypress2()"></textarea>
			</td>
		...
		<tr class="er">
			...
			<td>
				...
				<c:if test="${user != null }">
					<span><input type="submit" value="发表评论" class="san"/></span>
				</c:if>
				<c:if test="${user == null }">
					登录后才能评论哦
				</c:if>
