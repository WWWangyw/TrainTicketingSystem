...
<body>
<form name="fom" id="fom" method="post" action="/TrainStation/GetUsersServlet">
              ...
              <tr>
                <td height="40" class="font42"><table width="100%" border="0" cellpadding="4" cellspacing="1" bgcolor="#464646" class="newfont03">
                  ...
                  <tr>
                    ...
                    <td align="center" bgcolor="#FFFFFF"><a href="/TrainStation/GetUserServlet?id=${user.id}" style="color:blue;">${user.username }</a></td>
                    ...
                    <td align="center" bgcolor="#FFFFFF">
                    	<a href="/TrainStation/ToUpdateUserServlet?id=${user.id}" style="color:blue;">编辑</a>
                    	/<a style="color:blue;" href="javascript:if(confirm('您确定要删除吗？')){window.location.href='/TrainStation/DeleteUserServlet?id=${user.id}'}">删除</a>
                   	</td>
                  </tr>
                  </c:forEach>
                  </c:if>
