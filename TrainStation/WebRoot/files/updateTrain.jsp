...
<title>修改火车车次信息</title>
<link rel="stylesheet" rev="stylesheet" href="/TrainStation/css/style.css" type="text/css" media="all" />
...
<script language="JavaScript" type="text/javascript">
	...
	function $(id){
 	...
 	function checkTrainNum(){ 
		...
		var reg = /^[G|T|K|D|L|Z]{0,1}[0-9]{1,5}$/;
		if(train_num==""){
...
<body class="ContentBody">
  <form action="/TrainStation/UpdateTrainServlet" method="post"  name="form1"  onsubmit="checkit()">
				...
				<fieldset style="height:100%;">
					  ...
					  <tr >
					    ...
					    <td>
				        	...
				        	<span class="red">* </span>
				        	<span style="color:#2e3192;">必填，格式如：上海/苏州/无锡/镇江/南京</span>
