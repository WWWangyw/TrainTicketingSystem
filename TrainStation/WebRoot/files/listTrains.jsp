...
<link href="/TrainStation/css/css.css" rel="stylesheet" type="text/css" />
...
<link href="/TrainStation/css/style.css" rel="stylesheet" type="text/css" />
</head>

<body>
<form name="fom" id="fom" method="post" action="/TrainStation/GetTrainsServlet">
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  ...
  <tr>
    ...
    <table width="100%" border="0" cellspacing="0" cellpadding="0">
        <tr>    
          <td height="62" background="/TrainStation/images/nav04.gif">
            
		   <table width="98%" border="0" align="center" cellpadding="0" cellspacing="0">
		    <tr>
			  <td width="24"><img src="/TrainStation/images/ico07.gif" width="20" height="18" /></td>
			  <td width="519">
                ...
                <td height="40" class="font42"><table width="100%" border="0" cellpadding="4" cellspacing="1" bgcolor="#464646" class="newfont03">
                 ...
                 <tr>
                  ...
                  <tr>
                    ...
                    <td  align="center" bgcolor="#FFFFFF"><a href="/TrainStation/GetTrainServlet?train_num=${station.train_num }" style="color:blue;">${station.train_num }</a></td>
                    ...
                    <td align="center" bgcolor="#FFFFFF">
                    	<a href="/TrainStation/ToUpdateTrainServlet?train_num=${station.train_num}" style="color:blue;">编辑</a>
                    	/<a style="color:blue;" href="javascript:if(confirm('您确定要删除吗？')){window.location.href='/TrainStation/DeleteTrainServlet?train_num=${station.train_num}'}">删除</a>
                   	</td>
                  </tr>
                  </c:forEach>
                  </c:if>
