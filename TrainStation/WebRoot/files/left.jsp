    ...
    <TD>
		...
		<table id="subtree8" style="DISPLAY: none" width="80%" border="0" align="center" cellpadding="0" 
				...
				<tr>
				  ...
				  <td width="91%"><a href="/TrainStation/GetTrainsServlet" target="mainFrame" class="left-font03" onClick="tupian('21');">车次管理</a></td>
				</tr>
      </table>
	  ...
	  <table id="subtree2" style="DISPLAY: none" width="80%" border="0" align="center" cellpadding="0" cellspacing="0" class="left-table02">
		...
		<tr>
				  ...
				  <td width="91%">
						<a href="/TrainStation/files/listTrain.jsp" target="mainFrame" class="left-font03" onClick="tupian('24');">车次查询</a></td>
			</tr>
      </table>
		...
		<table id="subtree7" style="DISPLAY: none" width="80%" border="0" align="center" cellpadding="0" 
				...
				<tr>
				  <td width="9%" height="20" ><img id="xiaotu24" src="../images/ico06.gif" width="8" height="12" /></td>
				  <td width="91%">
						<a href="/TrainStation/buyTicket/buyTicket.jsp" target="mainFrame" class="left-font03" onClick="tupian('24');">购&nbsp;&nbsp;&nbsp;&nbsp;票
							</a></td>
				</tr>
      </table>
		...
		<table id="subtree1" style="DISPLAY: none" width="80%" border="0" align="center" cellpadding="0" 
			...
			<tr>
				  <td width="9%" height="20" ><img id="xiaotu24" src="../images/ico06.gif" width="8" height="12" /></td>
				  <td width="91%">
						<a href="/TrainStation/GetMyOrderServlet?user_id=${commonUsers.id }" target="mainFrame" class="left-font03" onClick="tupian('24');">退&nbsp;&nbsp;&nbsp;&nbsp;票
							</a></td>
			</tr>	
      </table>
	  ...
	  <table id="subtree3" style="DISPLAY: none" width="80%" border="0" align="center" cellpadding="0" cellspacing="0" class="left-table02">
        ...
        <tr>
          <td width="9%" height="20" ><img id="xiaotu8" src="../images/ico06.gif" width="8" height="12" /></td>
          <td width="91%"><a href="/TrainStation/GetUsersServlet" target="mainFrame" class="left-font03" onClick="tupian('8');">管理用户</a></td>
        </tr>
      </table>
	  ...
	  <table id="subtree4" style="DISPLAY: none" width="80%" border="0" align="center" cellpadding="0" cellspacing="0" class="left-table02">
		<tr>
          ...
          <td width="91%"><a href="/TrainStation/GetMyOrderServlet?user_id=${commonUsers.id }" target="mainFrame" class="left-font03" onClick="tupian('11');">我的订单</a></td>
        </tr>
	  	<tr>
          <td width="9%" height="20" ><img id="xiaotu12" src="../images/ico06.gif" width="8" height="12" /></td>
          <td width="91%"><a href="/TrainStation/GetAllOrderServlet" target="mainFrame" class="left-font03" onClick="tupian('12');">所有订单</a></td>
        </tr>
      </table>
		...
		<table id="subtree9" style="DISPLAY: none" width="80%" border="0" align="center" cellpadding="0" 
				...
				<tr>
				  ...
				  <td width="91%">
				  	<a href="/TrainStation/files/personalInformation.jsp" target="mainFrame" class="left-font03" onClick="tupian('22');">查看个人信息</a>
				 </td>
				</tr>
				<tr>
				  <td width="9%" height="23" ><img id="xiaotu23" src="../images/ico06.gif" width="8" height="12" /></td>
				  <td width="91%"><a href="/TrainStation/files/updatePersonInformation.jsp" target="mainFrame" class="left-font03" 
						onClick="tupian('23');">修改个人信息</a></td>
				</tr>
				<tr>
				  <td width="9%" height="23" ><img id="xiaotu23" src="../images/ico06.gif" width="8" height="12" /></td>
				  <td width="91%"><a href="/TrainStation/files/updatePassword.jsp" target="mainFrame" class="left-font03" 
        ...
        <tr>
          <td height="29"><table width="85%" border="0" align="center" cellpadding="0" cellspacing="0">
              <tr>
                ...
                <td width="92%"><a href="/TrainStation/Lylogin.jsp"  target="_blank"  class="left-font03" onClick="list('6');">意见留言</a></td>
              </tr>
          </table></td>
        </tr>
      </table>
<!--	  <table id="subtree6" style="DISPLAY: none" width="80%" border="0" align="center" cellpadding="0" cellspacing="0" class="left-table02">
        <tr>
          ...
          <td width="91%"><a href="/TrainStation/files/userHandbook.jsp" target="mainFrame" class="left-font03" onClick="tupian('15');">用户手册</a></td>
        </tr>
        <tr>
          <td height="20"><img id="xiaotu16" src="../images/ico06.gif" width="8" height="12" /></td>
          <td><a href="/TrainStation/files/rules.jsp" target="mainFrame" class="left-font03" onClick="tupian('16');">规章制度</a></td>
        </tr>
      </table>
	  -->
