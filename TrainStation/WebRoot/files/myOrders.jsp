...
<body>
<form name="fom" id="fom" method="post" action="/TrainStation/GetMyOrderServlet">
              ...
              <tr>
                <td height="40" class="font42"><table width="100%" border="0" cellpadding="4" cellspacing="1" bgcolor="#464646" class="newfont03">
                  ...
                  <tr>
                    ...
                    <td align="center" bgcolor="#FFFFFF">
                    	<a style="color:blue;" href="javascript:if(confirm('您确定要退票吗？')){window.location.href='/TrainStation/ReturnTicketServlet?order_id=${order.id}&train_num=${order.train_num }&user_id=${order.user_id }'}">退票</a>
                   	</td>
                  </tr>
                  </c:forEach>
                  </c:if>
