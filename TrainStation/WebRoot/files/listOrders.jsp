...
<body>
<form name="fom" id="fom" method="post" action="/TrainStation/GetAllOrderServlet">
                ...
                <td height="40" class="font42"><table width="100%" border="0" cellpadding="4" cellspacing="1" bgcolor="#464646" class="newfont03">
                 ...
                 <tr>
                  ...
                  <tr>
                    ...
                    <td  align="center" bgcolor="#FFFFFF"><a href="/TrainStation/GetOrderServlet?order_id=${order.id }" style="color:blue;">${order.id }</a></td>
                    ...
                    <td align="center" bgcolor="#FFFFFF">
                    	<a style="color:blue;" href="javascript:if(confirm('您确定要删除该订单吗？')){window.location.href='/TrainStation/ReturnTicketServlet?order_id=${order.id}&train_num=${order.train_num }&user_id=${order.user_id }'}">删除</a>
                   	</td>
                  </tr>
                  </c:forEach>
                  </c:if>
